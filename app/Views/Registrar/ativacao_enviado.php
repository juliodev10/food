                ...
                <div class="col-lg-6 d-flex align-items-center justify-content-center">
                    <div class="auth-form-transparent text-left p-3">
                        ...
                        <div class="ativacao-card">
                            <h4><?= esc($titulo) ?></h4>
                            <p>
                                Enviamos um link de ativação para o e-mail informado<br>no cadastro.
                                Verifique também sua caixa de spam.
                            </p>
                            <p class="mb-4">
                                Após ativar sua conta, volte para realizar o login.
                            </p>

                            <a href="<?php echo site_url('login'); ?>" class="btn btn-primary btn-lg font-weight-medium">
                                Ir para o login
                            </a>
                        </div>
                    </div>
