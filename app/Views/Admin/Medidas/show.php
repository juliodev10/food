        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text">
                    ...
                    <?= esc($medida->ativo ? 'Sim' : 'Não'); ?>
                </p>
                <p class="card-text">
                    <span class="font-weight-bold">Criado:</span>
                    <?= esc($medida->criado_em->humanize()); ?>
                </p>
                <?php if ($medida->deletado_em == null): ?>
                    <p class="card-text">
                        <span class="font-weight-bold">Atualizado:</span>
                        <?= esc($medida->atualizado_em->humanize()); ?>
                    </p>
                <?php else: ?>
                    <p class="card-text">
                        <span class="font-weight-bold text-danger">Excluído:</span>
                        <?= esc($medida->deletado_em->humanize()); ?>
                    </p>
                <?php endif; ?>
                <div class="mt-4">
                    <?php if ($medida->deletado_em == null): ?>
                        <div class="card-footer bg-primary d-flex justify-content-start">
                            <a href="<?= site_url("admin/medidas"); ?>" class="btn btn-light btn-sm btn-icon-text mr-2">
                        ...
                        <?php else: ?>
                            ...
                            <a href="<?= site_url("admin/medidas/desfazerExclusao/$medida->id"); ?>" class="btn btn-info
